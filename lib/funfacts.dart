...
class FunFactPage extends StatelessWidget {
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Text(
          'Discover interesting tidbits about carbon footprint and environmental impact.',
  ...
  Widget _buildFunFactsList(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('funfacts').snapshots(),
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            if (constraints.maxWidth > 600) {
              return _buildGridLayout(snapshot.data!.docs);
            } else {
              return _buildListLayout(snapshot.data!.docs);
            }
          },
        );
      },
  ...
  Widget _buildGridLayout(List<QueryDocumentSnapshot> funFacts) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildFunFactCard(funFacts[index]);
      },
    );
  }

  Widget _buildListLayout(List<QueryDocumentSnapshot> funFacts) {
  ...
  Widget _buildFunFactCard(QueryDocumentSnapshot document) {
